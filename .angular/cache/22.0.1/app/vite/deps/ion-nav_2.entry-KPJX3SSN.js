...
var Nav = class {
  ...
  async componentDidLoad() {
    this.didLoad = true;
    this.rootChanged();
    this.gesture = (await import("./swipe-back-B2CmabKY-EDB2M5UR.js")).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
...
//# sourceMappingURL=ion-nav_2.entry-KPJX3SSN.js.map
